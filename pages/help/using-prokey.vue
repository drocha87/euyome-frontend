<template>
  <v-container>
    <v-card flat class="mx-auto" max-width="800px">
      <v-card-title>
        Usando uma chave PRO
      </v-card-title>
      <v-card-subtitle class="text-caption">
        Neste tutorial iremos aprender usar sua chave PRO
      </v-card-subtitle>
      <v-card-text class="text-justify">
        Após você criar uma conta aqui na euyo.me ou comprar uma chave PRO,
        você precisa associar ela a algum perfil, e como nós já temos um perfil
        criado, é hora de associar ele com nossa chave.<br><br>

        Para isso nos precisamos ir na tela das nossas chaves clicando em
        ...
        Com isso você será redirecionada para a tela das suas chaves, como mostrado na imagem
        a seguir:
        ...
        que você tem. Nesta tela temos uma tabela das nossas chaves com as seguintes
        informações:
        ...
        <v-card flat outlined class="mt-6">
          ...
          <v-card-text>
            Aqui você tem um menu listavel (drop-down) com os perfis que você tem criado,
            escolhendo um perfil aqui, automaticamente associa esta chave a este perfil,
            tornando o perfil PRO. A qualquer momento você pode remover o perfil da chave,
            clicando novamente no menu e escolhendo <Highlight>Remover Perfil</Highlight>
          </v-card-text>
        </v-card>
        ...
        <v-card flat outlined class="my-6">
          ...
          <v-card-text>
            Aqui é bem fácil de entender, <Highlight>Criada em</Highlight> é quando
            sua chave foi criada e <Highlight>Expira em</Highlight> é quando sua
            chave irá expirar.
          </v-card-text>
        </v-card>
      ...
      <v-card-actions>
        ...
        <v-spacer></v-spacer>
        <v-btn text color="primary" disabled to="/help/using-prokey">Próximo</v-btn>
      </v-card-actions>
    </v-card>
  </v-container>
</template>
